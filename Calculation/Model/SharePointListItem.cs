...
namespace SCI.CIProject.ProjectSaving
{
    public class SharePointListItem
    {
        ...
        public string CA_Actual_Jan { get; set; }
        public string CA_Actual_Feb { get; set; }
        public string CA_Actual_Mar { get; set; }
        public string CA_Actual_Apr { get; set; }
        public string CA_Actual_May { get; set; }
        public string CA_Actual_Jun { get; set; }
        public string CA_Actual_Jul { get; set; }
        public string CA_Actual_Aug { get; set; }
        public string CA_Actual_Sep { get; set; }
        public string CA_Actual_Oct { get; set; }
        public string CA_Actual_Nov { get; set; }
        public string CA_Actual_Dec { get; set; }
        public string CA_Target_Jan { get; set; }
        public string CA_Target_Feb { get; set; }
        public string CA_Target_Mar { get; set; }
        public string CA_Target_Apr { get; set; }
        public string CA_Target_May { get; set; }
        public string CA_Target_Jun { get; set; }
        public string CA_Target_Jul { get; set; }
        public string CA_Target_Aug { get; set; }
        public string CA_Target_Sep { get; set; }
        public string CA_Target_Oct { get; set; }
        public string CA_Target_Nov { get; set; }
        public string CA_Target_Dec { get; set; }
        public string CR_Actual_Jan { get; set; }
        public string CR_Actual_Feb { get; set; }
        public string CR_Actual_Mar { get; set; }
        public string CR_Actual_Apr { get; set; }
        public string CR_Actual_May { get; set; }
        public string CR_Actual_Jun { get; set; }
        public string CR_Actual_Jul { get; set; }
        public string CR_Actual_Aug { get; set; }
        public string CR_Actual_Sep { get; set; }
        public string CR_Actual_Oct { get; set; }
        public string CR_Actual_Nov { get; set; }
        public string CR_Actual_Dec { get; set; }
        public string CR_Target_Jan { get; set; }
        public string CR_Target_Feb { get; set; }
        public string CR_Target_Mar { get; set; }
        public string CR_Target_Apr { get; set; }
        public string CR_Target_May { get; set; }
        public string CR_Target_Jun { get; set; }
        public string CR_Target_Jul { get; set; }
        public string CR_Target_Aug { get; set; }
        public string CR_Target_Sep { get; set; }
        public string CR_Target_Oct { get; set; }
        public string CR_Target_Nov { get; set; }
        public string CR_Target_Dec { get; set; }
        public string RG_Actual_Jan { get; set; }
        public string RG_Actual_Feb { get; set; }
        public string RG_Actual_Mar { get; set; }
        public string RG_Actual_Apr { get; set; }
        public string RG_Actual_May { get; set; }
        public string RG_Actual_Jun { get; set; }
        public string RG_Actual_Jul { get; set; }
        public string RG_Actual_Aug { get; set; }
        public string RG_Actual_Sep { get; set; }
        public string RG_Actual_Oct { get; set; }
        public string RG_Actual_Nov { get; set; }
        public string RG_Actual_Dec { get; set; }
        public string RG_Target_Jan { get; set; }
        public string RG_Target_Feb { get; set; }
        public string RG_Target_Mar { get; set; }
        public string RG_Target_Apr { get; set; }
        public string RG_Target_May { get; set; }
        public string RG_Target_Jun { get; set; }
        public string RG_Target_Jul { get; set; }
        public string RG_Target_Aug { get; set; }
        public string RG_Target_Sep { get; set; }
        public string RG_Target_Oct { get; set; }
        public string RG_Target_Nov { get; set; }
        public string RG_Target_Dec { get; set; }
        public string CI_Actual_Jan { get; set; }
        public string CI_Actual_Feb { get; set; }
        public string CI_Actual_Mar { get; set; }
        public string CI_Actual_Apr { get; set; }
        public string CI_Actual_May { get; set; }
        public string CI_Actual_Jun { get; set; }
        public string CI_Actual_Jul { get; set; }
        public string CI_Actual_Aug { get; set; }
        public string CI_Actual_Sep { get; set; }
        public string CI_Actual_Oct { get; set; }
        public string CI_Actual_Nov { get; set; }
        public string CI_Actual_Dec { get; set; }
        public string CI_Target_Jan { get; set; }
        public string CI_Target_Feb { get; set; }
        public string CI_Target_Mar { get; set; }
        public string CI_Target_Apr { get; set; }
        public string CI_Target_May { get; set; }
        public string CI_Target_Jun { get; set; }
        public string CI_Target_Jul { get; set; }
        public string CI_Target_Aug { get; set; }
        public string CI_Target_Sep { get; set; }
        public string CI_Target_Oct { get; set; }
        public string CI_Target_Nov { get; set; }
        public string CI_Target_Dec { get; set; }
        public string Total_Actual_Jan { get; set; }
        public string Total_Actual_Feb { get; set; }
        public string Total_Actual_Mar { get; set; }
        public string Total_Actual_Apr { get; set; }
        public string Total_Actual_May { get; set; }
        public string Total_Actual_Jun { get; set; }
        public string Total_Actual_Jul { get; set; }
        public string Total_Actual_Aug { get; set; }
        public string Total_Actual_Sep { get; set; }
        public string Total_Actual_Oct { get; set; }
        public string Total_Actual_Nov { get; set; }
        public string Total_Actual_Dec { get; set; }
        public string Total_Target_Jan { get; set; }
        public string Total_Target_Feb { get; set; }
        public string Total_Target_Mar { get; set; }
        public string Total_Target_Apr { get; set; }
        public string Total_Target_May { get; set; }
        public string Total_Target_Jun { get; set; }
        public string Total_Target_Jul { get; set; }
        public string Total_Target_Aug { get; set; }
        public string Total_Target_Sep { get; set; }
        public string Total_Target_Oct { get; set; }
        public string Total_Target_Nov { get; set; }
        public string Total_Target_Dec { get; set; }
        public string SavedOver12Months_CA { get; set; }
        public string SavedOver12Months_CR { get; set; }
        public string SavedOver12Months_RG { get; set; }
        public string SavedOver12Months_CI { get; set; }
        public string SavedOver12Months_Total { get; set; }
        public string SavedYearToDate_CA { get; set; }
        public string SavedYearToDate_CR { get; set; }
        public string SavedYearToDate_RG { get; set; }
        public string SavedYearToDate_CI { get; set; }
        public string SavedYearToDate_Total { get; set; }
        public string EstimatedSaving_CA { get; set; }
        public string EstimatedSaving_CR { get; set; }
        public string EstimatedSaving_RG { get; set; }
        public string EstimatedSaving_CI { get; set; }
        public string EstimatedSaving_Total { get; set; }
        ...
        public static SharePointListItem Convert(ProjectCost projectCost, int monthToStart)
        {
            ...
            item.CI_Target_Jan = ToProcessedString(projectCost.GetCostEntry(ProjectType.CapacityIncrease, CostType.Actual, 1));
            item.CI_Target_Feb = ToProcessedString(projectCost.GetCostEntry(ProjectType.CapacityIncrease, CostType.Actual, 2));
            item.CI_Target_Mar = ToProcessedString(projectCost.GetCostEntry(ProjectType.CapacityIncrease, CostType.Actual, 3));
            item.CI_Target_Apr = ToProcessedString(projectCost.GetCostEntry(ProjectType.CapacityIncrease, CostType.Actual, 4));
            item.CI_Target_May = ToProcessedString(projectCost.GetCostEntry(ProjectType.CapacityIncrease, CostType.Actual, 5));
            item.CI_Target_Jun = ToProcessedString(projectCost.GetCostEntry(ProjectType.CapacityIncrease, CostType.Actual, 6));
            item.CI_Target_Jul = ToProcessedString(projectCost.GetCostEntry(ProjectType.CapacityIncrease, CostType.Actual, 7));
            item.CI_Target_Aug = ToProcessedString(projectCost.GetCostEntry(ProjectType.CapacityIncrease, CostType.Actual, 8));
            item.CI_Target_Sep = ToProcessedString(projectCost.GetCostEntry(ProjectType.CapacityIncrease, CostType.Actual, 9));
            item.CI_Target_Oct = ToProcessedString(projectCost.GetCostEntry(ProjectType.CapacityIncrease, CostType.Actual, 10));
            item.CI_Target_Nov = ToProcessedString(projectCost.GetCostEntry(ProjectType.CapacityIncrease, CostType.Actual, 11));
            item.CI_Target_Dec = ToProcessedString(projectCost.GetCostEntry(ProjectType.CapacityIncrease, CostType.Actual, 12));
