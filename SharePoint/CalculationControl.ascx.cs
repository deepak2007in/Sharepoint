...
namespace SharePoint
{
    public partial class CalculationControl : System.Web.UI.UserControl
    {
        ...
        private void ProcessTotalCost(int[] months)
        {
            ...
            var caSavedOver12Months = projectCost.GetSavedOver12Months(ProjectType.CostAvoidance);
            var crSavedOver12Months = projectCost.GetSavedOver12Months(ProjectType.CostReduction);
            var rgSavedOver12Months = projectCost.GetSavedOver12Months(ProjectType.RevenueGrowth);
            var ciSavedOver12Months = projectCost.GetSavedOver12Months(ProjectType.CapacityIncrease);
